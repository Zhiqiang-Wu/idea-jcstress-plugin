 ...
 * @date 2022/8/24
 */
public class JCStressCommandLineState
        extends BaseJavaApplicationCommandLineState<JCStressRunConfiguration> {

    public JCStressCommandLineState(
            ExecutionEnvironment environment, @NotNull JCStressRunConfiguration configuration) {
    ...
    protected JavaParameters createJavaParameters() throws CantRunException {
        ...
        JavaParametersUtil.configureModule(
                this.myConfiguration.getConfigurationModule(), parameters, classpathType, null);
